...
<form name="eventadd" method="post" onSubmit="submitForm()" action="addevent.php">
...
<tr>
		<td colspan="2" class="listingcell">
			<font class="basictext"><b>Note: You donot have permission to add events to <?php echo $calname ?></b></font><br />
		</td>
	...
	<tr>
		...
		<td colspan="1" align="left" class="listingcell">
			...
			?>
				...
				<font class="basictext">You donot have any calendar privileges, 
				<br />
				<a href="mailto:<?php echo $_CONF['support_email'] ?>" class="basiclink">
				contact your administration</a></font>
