	...
	<table border="1" cellpadding="6" cellspacing="0" class="table" width="770">
		<tr>
			...
			<td class="theader" colspan="1" align="right">
				...
				<a href="locationdelete.php?lid=<?php echo $location_id ?>" class="tableheaderlink" onClick="return confirm('Deleting this location will also delete the related events. Are you sure you want delete this location?')"><b>Delete Location</b></a>&nbsp;&nbsp;
