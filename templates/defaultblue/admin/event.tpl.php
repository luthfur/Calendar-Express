...
<tr>
	<td valign="top" colspan="2">
		<br />
		<font class="bigtext">Events List</font>
		<br />
...
<tr>
	...
	<td align="right">
		...
		<a href="javascript:select_all('eid[]')" class="basiclink" >Select All</a>&nbsp;&nbsp;
		<a href="javascript:clear_all('eid[]')" class="basiclink" >Clear All</a>&nbsp;&nbsp;
...
<tr>
	...
	?>
		...
		<tr>
			<td class="listingheader" height="25" width="20">
					<input type="checkbox" value="<?php echo $event_id ?>" name="eid[]" />
				</td>
				...
				<td colspan="1" align="center" class="listingcell">	
					<a href="eventdelete.php?eid=<?php echo $event_id ?>" class="listinglink" onClick="return confirm('Are you sure you want to delete the selected event?')"><b>Delete</b></a>
				</td>
			</tr>
