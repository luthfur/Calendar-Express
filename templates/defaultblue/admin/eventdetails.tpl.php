...
<form name="eventupdate" method="post" action="updateevent.php" onSubmit="submitForm()">
	...
	<table border="1" cellpadding="6" cellspacing="0" class="table" width="85%">
		<tr>
			...
			<td class="theader" colspan="1" align="right">
				...
				<a href="eventdelete.php?eid=<?php echo $event_id ?>" class="catlink" onClick="return confirm('Are you sure you want to delete the selected event?')"><b>Delete</b></a>&nbsp;
