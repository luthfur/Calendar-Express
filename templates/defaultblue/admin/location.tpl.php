...
<tr>
	<td valign="top" colspan="2">
		<br />
		<font class="bigtext">Location List</font>
		<br />
...
<tr>
	...
	<td align="right">
		...
		<a href="javascript:select_all('lid[]')" class="basiclink" >Select All</a>&nbsp;&nbsp;
		<a href="javascript:clear_all('lid[]')" class="basiclink" >Clear All</a>&nbsp;&nbsp;
...
<tr>
	...
	?>
		...
		<tr>
				<td class="listingheader" height="25" width="20">
					<input type="checkbox" value="<?php echo $location_id ?>" name="lid[]" />
				</td>
				...
				<td colspan="1" align="center" class="listingcell">	
					<a href="locationdelete.php?lid=<?php echo $location_id ?>" class="listinglink" onClick="return confirm('Deleting this location will also delete the related events. Are you sure you want to delete the selected Location?')"><b>Delete</b></a>
				</td>
			</tr>
